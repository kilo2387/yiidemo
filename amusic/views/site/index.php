...
// $this->beginContent('@amusic/views/layouts/navList.php');
?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    <link rel="stylesheet" type="text/css" href="./H-ui.admin/static/h-ui.admin/skin/green/skin.css" id="skin" />
...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">STING.music</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="./H-ui.admin/welcome.html"></iframe>
        </div>
    </div>
</section>
